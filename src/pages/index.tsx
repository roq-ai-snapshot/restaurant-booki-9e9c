  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Restaurant Booking Engine - Empowering Restaurants and Simplifying Dining. A comprehensive solution for table reservations and menu management, designed for restaurateurs and loved by diners."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Restaurant Booking Engine - Empowering Restaurants and Simplifying Dining. A comprehensive solution for table reservations and menu management, designed for restaurateurs and loved by diners.`}
            </Text>
            <Box
